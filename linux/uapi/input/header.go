...
func EVIOCGREP() (uint32, error) {
	return ioctl.IOR[[2]uint32]('E', 0x03)
}
...
func EVIOCSREP() (uint32, error) {
	return ioctl.IOW[[2]uint32]('E', 0x03)
}
...
func EVIOCGKEYCODE() (uint32, error) {
	return ioctl.IOR[[2]uint32]('E', 0x04)
}
...
func EVIOCGKEYCODE_V2() (uint32, error) {
	return ioctl.IOR[InputKeymapEntry]('E', 0x04)
}
...
func EVIOCSKEYCODE() (uint32, error) {
	return ioctl.IOW[[2]uint32]('E', 0x04)
}
...
func EVIOCSKEYCODE_V2() (uint32, error) {
	return ioctl.IOW[InputKeymapEntry]('E', 0x04)
}
...
func EVIOCGBIT(ev InputEventCode, length uint32) (uint32, error) {
	return ioctl.IOC(ioctl.IOC_READ, 'E', uint32(0x20+ev), length)
}

// EVIOCGABS returns the ioctl request code for reading absolute-axis info
// into [InputAbsInfo].
func EVIOCGABS(abs InputAbsoluteCode) (uint32, error) {
	return ioctl.IOR[InputAbsInfo]('E', uint32(0x40+abs))
}

// EVIOCSABS returns the ioctl request code for writing absolute-axis info
// from AbsInfo.
func EVIOCSABS(abs InputAbsoluteCode) (uint32, error) {
	return ioctl.IOW[InputAbsInfo]('E', uint32(0xc0+abs))
}

// EVIOCSFF returns the ioctl request code for uploading (or updating)
// a force-feedback effect.
func EVIOCSFF() (uint32, error) {
	return ioctl.IOW[FFEffect]('E', 0x80)
}
...
func EVIOCGMASK() (uint32, error) {
	return ioctl.IOR[InputMask]('E', 0x92)
}
...
func EVIOCSMASK() (uint32, error) {
	return ioctl.IOW[InputMask]('E', 0x93)
}
